      ...
      <section className="py-24 px-6 bg-gradient-to-r from-red-900/30 via-zinc-900 to-red-900/30">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-zinc-400 mb-8">
            Suscríbete para recibir información sobre próximos eventos, nuevas
            grabaciones y sorpresas exclusivas. ¡Únete a nuestra familia
            musical!
          </p>
          <form
          ...
          {submittedEmails.length > 0 && (
            <div className="mt-8 p-4 bg-zinc-800/50 rounded-xl">
              <p className="text-sm text-zinc-500 mb-2">
                Ya hay {submittedEmails.length} fan(s) inscrito(s)
              </p>

            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <p className="text-zinc-400 mb-4 leading-relaxed">
                  ...
                  experiencia única llena de pasión, tradición y el ritmo que
                  nos caracteriza.
                </p>
                <p className="text-zinc-400 mb-6 leading-relaxed">
                  "Tu próxima canción favorita está a punto de sonar. Descubre
                  el ritmo que te hará vibrar con 'AN Los Layos'. ¡La música que
                  mueve tu mundo!"
                </p>

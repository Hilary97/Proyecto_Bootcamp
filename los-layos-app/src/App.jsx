...
const audioFiles = [
  ...
  { name: 'Cover - Ritmo Varonil', src: '/audio/AUDIO-2024-03-14-19-21-31.mp3' },
  { name: 'Cover - Recordando', src: '/audio/AUDIO-2024-03-28-19-00-22.mp3' },
  { name: 'Cover - Pasión Norteña', src: '/audio/AUDIO-2024-03-29-14-29-47.mp3' },
    ...
    <div className="min-h-screen bg-zinc-950 text-white font-sans">
      ...
      <section className="py-24 px-6 bg-zinc-900/50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-4">🎵 Nuestros Covers</h2>
          <p className="text-zinc-400 text-center mb-12 max-w-xl mx-auto">
            Disfruta de nuestras interpretaciones únicas de los clásicos norteños. 
            Cada cover está lleno de nuestra pasión y estilo único.
          </p>
          ...
          <div className="space-y-4">
            {audioFiles.map((audio, index) => (
              <div 
                ...
                onClick={() => setCurrentAudio(index === currentAudio ? null : index)}
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-zinc-500 text-sm">Click para reproducir</p>
                    </div>
                  </div>
                  <svg className={`w-5 h-5 text-zinc-500 transition-transform ${currentAudio === index ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                  </svg>
                </div>
                {currentAudio === index && (
                  <div className="mt-4">
                    <audio src={audio.src} controls className="w-full h-10" autoPlay />
                  </div>
                )}
              </div>
            ))}
      ...
      <section className="py-24 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <span className="text-red-600 font-bold tracking-wider uppercase">Sobre Nosotros</span>
              <h2 className="text-4xl font-bold mt-2 mb-6">La Música que Mueve Tu Mundo</h2>
              <p className="text-zinc-400 mb-4 leading-relaxed">
                Somos una empresa comprometida con la excelencia musical y la conexión genuina 
                con nuestro público. Cada presentación es una experiencia única llena de pasión, 
                tradición y el ritmo que nos caracteriza.
              </p>
              <p className="text-zinc-400 mb-6 leading-relaxed">
                "Tu próxima canción favorita está a punto de sonar. Descubre el ritmo que te 
                hará vibrar con 'AN Los Layos'. ¡La música que mueve tu mundo!"
              </p>
      ...
      <section className="py-24 px-6 bg-gradient-to-r from-red-900/30 via-zinc-900 to-red-900/30">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <h2 className="text-4xl font-bold mb-4">¡No Te Pierdas Nada!</h2>
          <p className="text-zinc-400 mb-8">
            Suscríbete para recibir información sobre próximos eventos, nuevas grabaciones 
            y sorpresas exclusivas. ¡Únete a nuestra familia musical!
          </p>
          <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4 justify-center">
            <input
              ...
              className="px-6 py-4 rounded-full bg-zinc-800 text-white border border-zinc-700 focus:border-red-600 focus:outline-none w-full sm:w-96"
            />
            <button
              type="submit"
              className="px-8 py-4 bg-red-600 hover:bg-red-700 text-white font-bold rounded-full transition-all transform hover:scale-105 shadow-lg shadow-red-600/30 whitespace-nowrap"
            >
              Suscribirme
            </button>
          </form>
          ...
          {submittedEmails.length > 0 && (
            <div className="mt-8 p-4 bg-zinc-800/50 rounded-xl">
              <p className="text-sm text-zinc-500 mb-2">Ya hay {submittedEmails.length} fan(s) inscrito(s)</p>
              <p className="text-green-500">✓ ¡Gracias por unirte!</p>
            </div>
          )}
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex gap-6">
              <a href="https://www.facebook.com/adiccionnortena.loslayos.1" target="_blank" rel="noopener noreferrer" className="text-zinc-400 hover:text-red-500 transition">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
              <a href="https://wa.me/message/EW4LOCEM23ERM1" target="_blank" rel="noopener noreferrer" className="text-zinc-400 hover:text-green-500 transition">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
